...
alter table public.sources drop constraint if exists sources_user_id_key;
alter table public.sources add constraint sources_user_id_key unique (user_id, id);
